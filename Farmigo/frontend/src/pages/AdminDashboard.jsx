      ...
      <div className="flex-1 ml-72 p-8 pt-10">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4 pl-6 border-l border-gray-100">
              <div className="text-right">
                ...
                <p className="text-[10px] font-bold text-[#137f13] uppercase tracking-widest">
                  Master Admin
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {statCards.map((stat, i) => (
            <div
              key={i}
              className="bg-white p-6 rounded-[32px] shadow-sm border border-gray-100 group hover:shadow-xl transition-all duration-500"
            >
              <div className="flex items-start justify-between mb-4">
                <div
                  className={`w-12 h-12 ${stat.color} text-white rounded-2xl flex items-center justify-center text-xl shadow-lg group-hover:scale-110 transition-transform`}
                >
                  {stat.icon}
                </div>
                <span
            ...
            <div className="space-y-4 relative z-10">
              {alerts.map((alert, i) => (
                ...
                >
                  ...
                  <p className="text-sm font-bold group-hover:text-[#ccff00] transition-colors">
                    {alert.title}
                  </p>
                </div>
              ))}
